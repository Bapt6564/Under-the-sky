...
const CONTES = {
  ...
  "deux-ourses": {
    ...
    texte: [
      ...
      `<h2>Odin, le corbeau et le test des samouraïs</h2>
       <p>Dans la tradition germanique, la Grande Ourse est perçue comme le char d'Odin, accompagné de trois chevaux — <a href="#/memo/alcor-mizar">Alcor</a> étant le corbeau d'Odin. Au niveau du manche du chariot, Mizar et sa voisine Alcor, plus faible, forment une paire d'étoiles. En raison de sa moindre luminosité, Alcor est surnommée en arabe « l'Oublié » ou « le Faible », et en chinois « l'Étoile assistante ». Chez les Amérindiens qui imaginent trois chasseurs poursuivant un ours, Alcor est soit le chien d'un chasseur, soit la marmite pour cuisiner l'ours une fois capturé.</p>
       <p>Dans l'Antiquité, Alcor et Mizar servaient de test de vision, car seules les personnes à la vue perçante les distinguent à l'œil nu. Au Japon, où on les nommait Nakaga et Miakaga, leur séparation évaluait la vue des samouraïs : ceux capables de distinguer Alcor étaient jugés aptes à devenir archers.</p>
       <p>Alcor apparaît même en littérature, dans <em>La Comtesse de Cagliostro</em> de Maurice Leblanc : son nom y est déduit de la phrase <em>Ad Lapidem Currebat Olim Regina</em> (« Vers la pierre courait autrefois la Reine »), et Leblanc imagine que le tracé de certaines abbayes du pays de Caux reproduit la Grande Ourse, Alcor indiquant l'emplacement d'un trésor caché.</p>`
    ],
  ...
  "origine-monde": {
    ...
    texte: [
      ...
      `<h2>Égypte — l'Ennéade d'Héliopolis</h2>
       <p>La plus ancienne cosmogonie égyptienne vient d'Héliopolis, vers 2700 avant notre ère. Au commencement n'existait que le <strong>Noun</strong>, une étendue d'eau infinie et chaotique. De cet océan primordial émergea une butte de terre, sur laquelle vint au monde le premier dieu, <strong>Atoum</strong> (ou Rê-Atoum), le démiurge. Seul, il engendra un premier couple : <strong>Shou</strong>, l'air, et <strong>Tefnout</strong>, l'humidité.</p>
       <p>De ce couple naquirent <strong>Geb</strong>, la Terre, et <strong>Nout</strong>, le Ciel — deux amants si étroitement enlacés qu'Atoum dut charger Shou de les séparer, l'air soulevant à jamais la voûte du ciel au-dessus de la terre. De Geb et Nout naquirent enfin <strong>Osiris</strong>, <strong>Isis</strong>, <strong>Seth</strong> et <strong>Nephtys</strong>, dont les histoires se prolongent dans le ciel (voir <a href="#/contes/orion-scorpion">Orion</a> et <a href="#/contes/lune">la Lune</a>).</p>
       <p>Ces neuf divinités — Atoum, Shou, Tefnout, Geb, Nout, Osiris, Isis, Seth et Nephtys — forment l'<strong>Ennéade</strong> (du grec <em>ennea</em>, « neuf »), le collège des forces fondamentales à l'origine du monde.</p>`
    ],
